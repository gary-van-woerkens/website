...
url: /docs/v2022.05.11/guides/linode/
aliases:
- /docs/v2022.05.11/guides/linode/README/
info:
  alicloud: v0.5.0
  aws: v0.5.0
  azurerm: v0.5.0
...
Now, install Kubeform Linode provider operator in your cluster following the steps [here](/docs/v2022.05.11/setup/README). To get a FREE license, please visit [here](https://license-issuer.appscode.com/?p=kubeform-community).
